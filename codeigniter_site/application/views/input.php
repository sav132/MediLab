        ...
        <div class="row">
          <div class="banner-info">
            ...
            <div class="banner-text text-center">
               	<div class="container">
              	<form class="well form-horizontal" action="<?php echo base_url();?>index.php/Input/register " method="post"  id="contact_form" style="background: rgba(13,70,83, 0);border:none;">
              	<fieldset>
              	<dir>
              	...
              	<div class="form-group"> 
              	  <label class="col-md-4 control-label">Sex</label>
              	    ...
              	    <div class="input-group">
              	        <span class="input-group-addon"></span>
              	    <select name="sex" class="form-control selectpicker" placeholder="Sex">
